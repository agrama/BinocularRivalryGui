...
my_shader = [
    ...
    """#version 140
        ...
        //uniform float x_shift2;
        
        

        void main() {
          vec2 texcoord1 = vec2(texcoord.x + xshift1, texcoord.y);
          vec2 texcoord2 = vec2(texcoord.x - xshift1*1.5, texcoord.y);
          vec4 color0 = texture(p3d_Texture0, texcoord1);
          vec4 color1 = texture(p3d_Texture1, texcoord2);
...
class MyApp(ShowBase):
    def __init__(self):
        ...
        self.xshift1 = 0
        self.cardnode.setShaderInput("xshift1", self.xshift1)
        self.xshiftspeed = 1
        self.pulsetimer = 0
